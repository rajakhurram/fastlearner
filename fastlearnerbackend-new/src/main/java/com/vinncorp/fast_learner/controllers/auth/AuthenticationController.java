...
public class AuthenticationController {
    ...
    public ResponseEntity<TokenResponse> localRegistration(@Valid @RequestBody LocalRegisterRequest request) throws InternalServerException, EntityAlreadyExistException, BadRequestException, EntityNotFoundException {
...
//        var m = service.sendingLinkForResettingPassword(email);
    ...
    ResponseEntity<TokenResponse> verifyAuthenticationOtp(@RequestParam String email, @RequestParam int otp) throws BadRequestException, EntityAlreadyExistException, InternalServerException, EntityNotFoundException {
