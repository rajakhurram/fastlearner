...
import com.vinncorp.fast_learner.services.authorize_net.checkout.IAuthorizeNetCheckoutService;
...
public class AuthorizeNetCheckoutController {

    private final IAuthorizeNetCheckoutService service;
