...
//                .isFavourite(e.get("is_favourite") != null && Boolean.parseBoolean("" + e.get("is_favourite")))
                ...
                .testTotalQuestion(
                        e.getElements().stream().anyMatch(column -> "test_total_question".equals(column.getAlias()))
                                && e.get("test_total_question") != null
                                ? ((Number) e.get("test_total_question")).longValue()
                                : null)
