...
public class Course extends Auditable<Long> {
    ...
    @Column(name = "pricing_locked", nullable = false)
    @Builder.Default
    private Boolean pricingLocked = false;
    @Column(name = "premium_conversion_used", nullable = false)
    @Builder.Default
    private Boolean premiumConversionUsed = false;
    @Enumerated(value = EnumType.STRING)
