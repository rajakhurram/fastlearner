...
public class TopicDetailForUpdateResponse {
    ...
    private String topicComprehensive;
...
//                    QuizQuestionAnswer quizQuestionAnswer = quizQuestionAnswers.stream().filter(q -> q.getTopicId().equals(topicId)).findAny().orElse(null);
                    ...
                    Boolean isAllowed = Objects.nonNull(e.get("is_allowed_to_retake")) && (Boolean) e.get("is_allowed_to_retake");
                    ...
                    TopicDetailForUpdateResponse data = TopicDetailForUpdateResponse.builder()
                            ...
                            .topicComprehensive((String) e.get("topic_comprehensive"))
                            ...
                            .generateAIReport(e.get("generate_ai_report") != null ? (Boolean) e.get("generate_ai_report") : null)
                            .reportPrompt((String) e.get("report_prompt"))
                            .testType(
                                    e.get("test_type") != null
                                            ? TestType.valueOf(e.get("test_type").toString())
                                            : null
                            )
                            .isAllowedToRetake(isAllowed)
                            .build();
                    return data;
                })
                .toList();
