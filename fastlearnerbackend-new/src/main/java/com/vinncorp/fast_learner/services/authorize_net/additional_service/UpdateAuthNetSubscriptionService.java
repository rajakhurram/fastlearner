...
public class UpdateAuthNetSubscriptionService {
     ...
     *
     * */
    public Message<String> update(SubscriptionRequest request, Subscription subscription, SubscribedUserProfile subscribedUserProfile,
        ...
        CreateSubscriptionResponse response = restClient.makeRequest("/v1/subscription/create", HttpMethod.POST, createSubsRequest, CreateSubscriptionResponse.class);
