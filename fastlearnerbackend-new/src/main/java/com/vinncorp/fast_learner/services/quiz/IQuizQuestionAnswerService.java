...
public interface IQuizQuestionAnswerService {
    ...
    List<QuizQuestionAnswers> findByQuizQuestionId(Long quizQuestionId) throws EntityNotFoundException;
    ...
    Message<QuizAnswerResponse> validateAnswers(List<ValidationAnswerRequest> validationAnswerRequests, String name) throws InternalServerException;
    Message<QuizQuestionAnswer> fetchPaginatedQuestionAndAnswersByTopicId(Long topicId, boolean forStudent, Boolean random, Pageable pageable, String email) throws EntityNotFoundException;

    String previewReport(PreviewReport previewReport, String username) throws BadRequestException, InternalServerException;
