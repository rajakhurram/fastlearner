...
public interface ISubscribedUserService {
    ...
    Message<String> completeAuthorizeNetSubscription(String authorizeNetSubscriptionId, String email) throws EntityNotFoundException, InternalServerException;
    ...
    Message<String> fetchCurrentSubscriptionPlanType(String name) throws EntityNotFoundException;

    SubscribedUser findBySubscribedUser(String email);
}
