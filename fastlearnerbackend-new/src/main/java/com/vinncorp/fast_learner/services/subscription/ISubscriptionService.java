...
public interface ISubscriptionService {
    Message<List<Subscription>> fetchAllSubscription() throws EntityNotFoundException;
    ...
    Message<List<Subscription>> fetchSubscriptionByCycle(String cycle) throws EntityNotFoundException;
