...
public interface ITransactionHistoryService {
    TransactionHistory findByAuthSubscriptionId(String authorizeNetSubscriptionId) throws EntityNotFoundException;

    TransactionHistory findByLatestTransactionHistoryBySubsIdAndStatus(String authorizeNetSubscriptionId, GenericStatus genericStatus) throws EntityNotFoundException;

    TransactionHistory findByLatestTransactionHistoryBySubsIdAndStatusAndSubscriptionStatus(String authorizeNetSubscriptionId,
