...
import com.vinncorp.fast_learner.controllers.notification.NotificationController;
...
public class UserProfileService implements IUserProfileService {
    ...
    public Message<UserProfileDto> getProfile(String profileUrl, String email) throws EntityNotFoundException, InternalServerException {
        ...
        boolean isProfileOwner = Objects.nonNull(user) && Objects.equals(userId, user.getId());
        if (!isProfileOwner) {
    ...
    public UserProfileVisitDto findNoOfUsersVisitedProfileBy(String period, Long instructorId) throws EntityNotFoundException {
        ...
        if ("all_time".equalsIgnoreCase(period)) {
            Long total = userProfileVisitRepo.countAllTimeProfileVisitors(userProfile.getId());
