...
public class UserService implements IUserService, UserDetailsService {
    ...
    public UserService(UserRepository repository, IRoleService roleService,
                       ...
                       ISubscribedUserService subscribedUserService, IEmailService emailService, PasswordEncoder passwordEncoder, ISubscriptionValidationsService subscriptionValidationsService) {
    ...
    @Override
    public Message<UserResponse> getUserDetail(String name) throws EntityNotFoundException {
        ...
        SubscriptionValidations subscriptionValidations = this.subscriptionValidationsService
                .findByValidationNameAndSubscriptionAndIsActive(
                        SubscriptionValidation.PDF_PAGE_COUNT.name(),
                        this.subscribedUserService.findByUser(name).getSubscription(),
                        true
                );
        ...
        UserResponse userResponse=UserResponse.builder()
                ...
                .noOfPagesUsed(user.get().getNoOfPagesUsed())
                .allowedPages(Objects.nonNull(subscriptionValidations) ? subscriptionValidations.getValue() : null)
                .build();
