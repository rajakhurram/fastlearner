...
public class APIUrls {
    ...
    public static final String GET_USER_WELCOME_STATUS = "/user-welcome-status";
    ...
    public static final String PARSE_TEST_BULK_QUESTIONS = "/test/bulk-questions/parse";
    ...
    public static final String GET_SUBSCRIPTION_BY_CYCLE = GET_URL + "cycle/" + "{cycle}";
    ...
    public static final String CURRENT_SUBSCRIPTION_PLAN_TYPE = "/plan-type";
    ...
    public static final String GET_QUESTIONS_AND_ANSWERS_BY_TOPIC = "/answers/topic";
    ...
    public static final String QUIZ_REPORT = API_MAIN + "/quiz-report";
    public static final String GET_BY_QUIZ_ATTEMPT_ID = GET_URL;
    ...
    public static final String PREVIEW_REPORT = POST_URL + "preview-report";

    public static final String QUIZ_ATTEMPT = API_MAIN +"/quiz/attempt";
    ...
    public static final String AUTHORIZE_NET_API= API_MAIN +"/authorizenet";
    ...
    //authorize.net checkout api urls
    ...
    // authorize.net webhook api urls
    ...
    public static final String COUPON_FETCH_BY_ID = "/{id}";
    public static final String COUPON_TOGGLE_STATUS = "/{id}/toggle-status";

    public static final String COUPON_VALIDATE = "/validate";

    //ai_grader api urls
    public static final String AI_GRADER_API = API_MAIN +"/ai-grader";
    public static final String CREATE_CLASS = "/create-class";
    public static final String GET_CLASS = "/get-class";
    public static final String GET_ALL_GRADERS = "/get-graders";
    public static final String GET_AI_GRADER_CLASS_EXPORT = "/export-class";
    public static final String GET_ALL_AI_GRADER_CLASS =GET_URL+ "all";
    public static final String DELETE_AI_GRADER_CLASS = DELETE_URL;
    public static final String UPDATE_CLASS = UPDATE_URL;
    public static final String GET_ALL_AI_GRADER_CLASS_STUDENT =GET_URL+ "student";

    public static final String CREATE_AI_GRADER = "/create";

    public static final String CREATE_AI_GRADER_LANDING_PAGE = "/create-landing-page";
    public static final String RETRY_GRADING = "/retry-grading";

    public static final String AI_RESULT = API_MAIN+"/ai-result";
    public static final String GET_RESULT_FILTER = GET_URL;

    public static final String GET_RESULT_BY_ID = GET_URL+"{id}";
    public static final String GET_AI_RESULT_QUESTIONS = "/questions";
    public static final String UPDATE_AI_RESULT_QUESTION = "/question/update";
    public static final String CREATE_MANUAL_QUESTION = "/question/manual";
    public static final String UPDATE_MANUAL_QUESTION = "/question/manual";
    public static final String DELETE_MANUAL_QUESTION = "/question/manual";
    public static final String UPDATE_AI_STUDENT_RESULT = "/update";
    public static final String DELETE_AI_RESULT = "/delete";
    public static final String UPDATE_STATUS = "/update/status";
    public static final String SEND_EMAIL = "/send-email";

    public static final String ASSESSMENT = API_MAIN+"/assessment";
    public static final String GET_ASSESSMENT = GET_URL;
    public static final String CREATE_ASSESSMENT = POST_URL + "create";
    public static final String GET_BY_CLASS_ID_AND_ASSESSMENT_ID =GET_URL +"class-id-and-assessment-id";
    public static final String UPDATE_ASSESSMENT = "/update";
    public static final String DELETE_ASSESSMENT = "/delete";
    public static final String ASSESSMENT_DETAILS = GET_URL +"details";
    public static final String GET_BY_CLASS_ID_AND_ASSESSMENT_ID_STUDENT =GET_URL+"class-and-assessment-id-student";

    // Super Admin API urls
    public static final String SUPER_ADMIN_API = API_MAIN + "/super-admin";

    // Users
    public static final String SUPER_ADMIN_GET_USERS = "/users";
    public static final String SUPER_ADMIN_GET_USER_STATS = "/users/stats";
    public static final String SUPER_ADMIN_GET_USER_OVERVIEW = "/users/{userId}/overview";
    public static final String SUPER_ADMIN_GET_USER_SUBSCRIPTIONS = "/users/{userId}/subscriptions";
    public static final String SUPER_ADMIN_GET_USER_COURSES = "/users/{userId}/courses";
    public static final String SUPER_ADMIN_GET_USER_TRANSACTIONS = "/users/{userId}/transactions";
    public static final String SUPER_ADMIN_USER_INVITE = "/users/invite";
    public static final String SUPER_ADMIN_USERS_CSV = "/users/exportCsv";
    // Subscriptions
    public static final String SUPER_ADMIN_GET_SUBSCRIPTION_STATS = "/subscriptions/stats";
    public static final String SUPER_ADMIN_GET_SUBSCRIPTIONS = "/subscriptions";
    public static final String SUPER_ADMIN_GET_SUBSCRIPTION_INVOICES = "/subscriptions/{subscriptionId}/invoices";

    // Courses
    public static final String SUPER_ADMIN_GET_COURSES = "/courses";
    public static final String SUPER_ADMIN_GET_COURSE_DETAIL = "/courses/{courseId}";
    public static final String SUPER_ADMIN_PUBLISH_COURSE   = "/courses/{courseId}/publish";
    public static final String SUPER_ADMIN_UNPUBLISH_COURSE = "/courses/{courseId}/unpublish";

    // Enrollments
    public static final String SUPER_ADMIN_GET_ENROLLMENTS = "/enrollments";

    // Payments
    public static final String SUPER_ADMIN_GET_PAYMENTS = "/payments";
    public static final String SUPER_ADMIN_EXPORT_PAYMENTS_CSV = "/payments/export";

    // Payouts
    public static final String SUPER_ADMIN_GET_PAYOUT_STATS = "/payouts/stats";
    public static final String SUPER_ADMIN_GET_PAYOUTS = "/payouts";
    public static final String SUPER_ADMIN_GET_PAYOUT_DETAIL = "/payouts/{instructorId}";

    // Settings
    public static final String SUPER_ADMIN_GET_ADMIN_USERS    = "/settings/admins";
    public static final String SUPER_ADMIN_ADD_ADMIN           = "/settings/admins";
    public static final String SUPER_ADMIN_DEACTIVATE_ADMIN    = "/settings/admins/{userId}/deactivate";

    // Instructors
    public static final String SUPER_ADMIN_GET_INSTRUCTORS = "/instructors";

    // Invoices
    public static final String SUPER_ADMIN_GET_INVOICES = "/invoices";
    public static final String SUPER_ADMIN_GET_INVOICE_DETAIL = "/invoices/{invoiceId}";
    public static final String SUPER_ADMIN_DOWNLOAD_INVOICE_PDF = "/invoices/{invoiceId}/pdf";
    public static final String SUPER_ADMIN_SEND_INVOICE_EMAIL = "/invoices/{invoiceId}/sendViaEmail";
}
