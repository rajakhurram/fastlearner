...
//                .subscriptionId(2L)
//                .couponType(CouponType.valueOf(CouponType.SUBSCRIPTION.name()))
...
//
//    @Test
//    void fetchAll_ReturnsCoupons_WhenCouponsExist() throws EntityNotFoundException, InternalServerException, EntityAlreadyExistException {
//        // Arrange
...
//    void createSubscription_SavesCouponWithAssociations_WhenRequestIsValid() throws InternalServerException, EntityAlreadyExistException {
//        // Act
//        couponRequest.setSubscriptionId(4L);
//        couponRequest.setCouponType(CouponType.valueOf("SUBSCRIPTION"));
