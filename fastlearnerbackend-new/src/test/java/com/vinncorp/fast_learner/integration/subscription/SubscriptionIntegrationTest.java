...
import com.vinncorp.fast_learner.services.subscription.process.CouponBasedSubscriptionService;
...
public class SubscriptionIntegrationTest {
    ...
    void testCreateSubscription_withCoupon_shouldReturnSuccess() throws Exception {
        ...
        // Perform request
        mockMvc.perform(post(AUTHORIZE_NET_API + CREATE_SUBSCRIPTION)
