...
import com.vinncorp.fast_learner.response.auth_net_checkout.TransactionResponse;
...
import com.vinncorp.fast_learner.services.authorize_net.checkout.AuthorizeNetCheckoutService;
...
public class AuthorizeNetCheckoutServiceTest {

    @InjectMocks
    private AuthorizeNetCheckoutService service;
