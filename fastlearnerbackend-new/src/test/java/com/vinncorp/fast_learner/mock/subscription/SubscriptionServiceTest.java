...
import com.vinncorp.fast_learner.dtos.authorize_net.webhook.Payload;
import com.vinncorp.fast_learner.dtos.authorize_net.webhook.Profile;
...
import com.vinncorp.fast_learner.repositories.authorize_net.WebhookLogRepository;
...
import com.vinncorp.fast_learner.services.authorize_net.webhook.AuthorizeNetWebhookService;
...
public class SubscriptionServiceTest {
    ...
    private AuthorizeNetWebhookService authorizeNetWebhookService;
    ...
    void setUp() {
        ...
        // Inject manually
        authorizeNetWebhookService = new AuthorizeNetWebhookService(subscriptionService,
                subscribedUserService, webhookLogRepo, transactionHistoryService, paymentProfileService, instructorPerformanceInsightService);
        /*ReflectionTestUtils.setField(
                authorizeNetWebhookService,
    ...
    void testSubscriptionTermination() throws EntityNotFoundException, InternalServerException {
        ...
        request.setEventType("net.authorize.customer.subscription.cancelled");
        ...
        // Act
        authorizeNetWebhookService.subscriptionTermination(request);
    ...
    void testFetchAllSubscription_Success() throws EntityNotFoundException {
        ...
        // Act
        Message<List<Subscription>> response = subscriptionService.fetchAllSubscription();
    ...
    void testFetchAllSubscription_NoSubscriptions() {
        ...
        EntityNotFoundException thrown = assertThrows(EntityNotFoundException.class, () ->
                        subscriptionService.fetchAllSubscription(),
