...
public class SubscribedUserServiceTest {
    ...
    @Test
    @DisplayName("Test: Complete Authorize.Net Subscription - Success")
    public void testCompleteAuthorizeNetSubscription_Success() throws EntityNotFoundException, InternalServerException {
        String authorizeNetSubscriptionId = "AUTHNET123";
        ...
        Message<String> response = service.completeAuthorizeNetSubscription(authorizeNetSubscriptionId, user.getEmail());

        assertEquals(HttpStatus.OK.value(), response.getStatus());
        assertEquals("Authorize.Net Subscription is completed.", response.getMessage());
        assertEquals("Authorize.Net Subscription is completed.", response.getData());

        assertEquals(authorizeNetSubscriptionId, subscribedUser.getSubscribedId());
        assertEquals(authorizeNetSubscriptionId, subscribedUser.getAuthorizeNetSubscriptionId());
        assertEquals(PaymentStatus.PAID, subscribedUser.getPaymentStatus());
    ...
    @Test
    @DisplayName("Test: Complete Authorize.Net Subscription - User Not Found")
    public void testCompleteAuthorizeNetSubscription_UserNotFound() {
        String authorizeNetSubscriptionId = "AUTHNET123";
        ...
        EntityNotFoundException thrownException = assertThrows(EntityNotFoundException.class,
                () -> service.completeAuthorizeNetSubscription(authorizeNetSubscriptionId, user.getEmail())
        );
    ...
    @Test
    @DisplayName("Test: Complete Authorize.Net Subscription - Update User Failure")
    public void testCompleteAuthorizeNetSubscription_UpdateUserFailure() throws EntityNotFoundException, InternalServerException {
        String authorizeNetSubscriptionId = "AUTHNET123";
    ...
    @Test
    @DisplayName("Test: Cancel Subscription - Success (Authorize.Net)")
    public void testCancelSubscription_Success_PayPal() throws EntityNotFoundException, BadRequestException, InternalServerException {
        ...
        doNothing().when(authNetAdditionalSubscriptionService).cancelAuthorizeNetSubscription(subscribedUser.getAuthorizeNetSubscriptionId());
        ...
        assertNull(subscribedUser.getAuthorizeNetSubscriptionId());

        verify(repo, times(1)).findByUserEmail(email);
        verify(authNetAdditionalSubscriptionService, times(1)).cancelAuthorizeNetSubscription(any());
    ...
    public void testCancelSubscription_NoActiveSubscription() throws EntityNotFoundException, InternalServerException, BadRequestException {
        ...
        verify(repo, times(1)).findByUserEmail(email);
        verify(authNetAdditionalSubscriptionService, times(0)).cancelAuthorizeNetSubscription(anyString());
