...
public interface  IAuthenticationService {
    ...
    TokenResponse localRegister(LocalRegisterRequest request) throws InternalServerException, EntityAlreadyExistException, EntityNotFoundException, BadRequestException;
    ...
    TokenResponse verifyAuthenticationOtp(String email, int otp) throws BadRequestException, EntityAlreadyExistException, InternalServerException, EntityNotFoundException;
