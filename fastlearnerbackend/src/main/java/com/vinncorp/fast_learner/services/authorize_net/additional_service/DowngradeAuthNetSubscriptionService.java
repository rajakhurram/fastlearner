...
public class DowngradeAuthNetSubscriptionService {
    ...
    public Message<String> downgrade(SubscriptionRequest request, Subscription subscription, SubscribedUserProfile subscribedUserProfile,
