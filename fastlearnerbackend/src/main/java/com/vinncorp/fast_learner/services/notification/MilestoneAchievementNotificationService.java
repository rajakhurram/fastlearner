...
public class MilestoneAchievementNotificationService implements IMilestoneAchievementNotificationService {
    ...
    @Override
    public void notifyToUserCertificateAwarded(String courseTitle, Long courseId, Long instructorId, Long receiverId, Course course) {
        log.info("Notifying certification completion.");
        rabbitMQProducer.sendMessageToLoggedInUser(courseTitle + ". Get your certificate here "+ courseTitle +".",
                receiverId, instructorId, "student/generate-certificate?courseId="+courseId, course.getContentType(),
     ...
     * FOR INSTRUCTOR (NO OF STUDENT COUNT)
     * */
    @Override
    ...
    /**
    * FOR STUDENT (HOW MUCH OF COURSE HAS BEEN COMPLETED IN PERCENTAGE)
    * */
    @Override
