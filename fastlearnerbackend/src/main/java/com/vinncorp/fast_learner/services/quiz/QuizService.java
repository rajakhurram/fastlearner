...
public class QuizService implements IQuizService{
    ...
    public Quiz findByQuizQuestionsId(Long questionId){
        return this.repo.findByQuizQuestions_Id(questionId).orElse(null);
    }

    public Optional<TestType> findQuizTestTypeByTopicId(Long topicId) {
        return repo.findTestTypeByTopicId(topicId);
    }
}
