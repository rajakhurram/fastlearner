...
public class UpdateProcess implements SubscriptionStrategyService {
    ...
    @Autowired
    private UpdateAuthNetSubscriptionService updateAuthNetSubscriptionService;
    @Autowired
...
//                continueTransactionHistory.setSubscriptionStatus(SubscriptionStatus.DISCONTINUE);
        ...
        Message<String> response = updateAuthNetSubscriptionService.update(requestDTO, nextSubscription, subscribedUserProfile, user,
