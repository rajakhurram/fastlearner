...
public class NotificationConstant {
    ...
    public static final String ASSESSMENT_CONTENT_TEXT = "Great news! Your assessment has been graded — please review your results.";
    ...
    public static final String SUBSCRIPTION_TERMINATION_CONTENT = "Subscription has been terminated.";
    ...
    public static String value(String username, String courseName, ContentType courseContentType, NotificationType notificationType) {
        ...
        switch (notificationType) {
            ...
            case SUBSCRIPTION_TERMINATION -> {
                return SUBSCRIPTION_TERMINATION_CONTENT;
            }
        }
        return null;
    }
