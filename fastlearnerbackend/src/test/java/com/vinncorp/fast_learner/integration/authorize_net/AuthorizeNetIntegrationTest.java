package com.vinncorp.fast_learner.integration.authorize_net;
...
public class AuthorizeNetIntegrationTest {
    ...
    public void createStandardSubscription_shouldReturnSuccess() throws Exception {
        mockMvc.perform(post(APIUrls.AUTHORIZE_NET_API + APIUrls.CREATE_SUBSCRIPTION)
    ...
    public void getSavedUserPaymentProfile_whenValidData() throws Exception {
        ...
        mockMvc.perform(get(APIUrls.AUTHORIZE_NET_API + APIUrls.GET_SAVED_PAYMENT_PROFILE)
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + JWT_TOKEN)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status").value(HttpStatus.OK.value()))
    ...
    public void addUserPaymentProfile_whenProvidedValidData() throws Exception {
        ...
        mockMvc.perform(post(APIUrls.AUTHORIZE_NET_API + APIUrls.ADD_PAYMENT_PROFILE)
    ...
    public void updateUserPaymentProfile_whenProvidedValidData() throws Exception {
        ...
        mockMvc.perform(post(APIUrls.AUTHORIZE_NET_API + APIUrls.UPDATE_PAYMENT_PROFILE)
                        .content(JsonUtil.asJsonString(paymentProfileDetailRequest))
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + JWT_TOKEN)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void updateUserPaymentProfile_whenProvidedInvalidData() throws Exception {
        ...
        ResultActions result = mockMvc.perform(post(APIUrls.AUTHORIZE_NET_API + APIUrls.UPDATE_PAYMENT_PROFILE)
                        .content(JsonUtil.asJsonString(paymentProfileDetailRequest))
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + JWT_TOKEN)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    public void deleteUserPaymentProfile_whenProvidedValidData() throws Exception {
        ...
        mockMvc.perform(get(APIUrls.AUTHORIZE_NET_API + "/payment-profile/" + profile.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, "Bearer " + JWT_TOKEN))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status").value(HttpStatus.OK.value()))
    ...
    public void deleteUserPaymentProfile_whenProvidedInvalidData() throws Exception {
        mockMvc.perform(get(APIUrls.AUTHORIZE_NET_API + "/payment-profile/999")
                        .contentType(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + JWT_TOKEN))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(HttpStatus.NOT_FOUND.value()))
    ...
    public void getAllPaymentProfile_whenValidData() throws Exception {
        ...
        mockMvc.perform(get(APIUrls.AUTHORIZE_NET_API + APIUrls.GET_ALL_PAYMENT_PROFILE)
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + JWT_TOKEN)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status").value(HttpStatus.OK.value()))
    ...
    void getBillingHistory_whenCustomerProfileIdNotExist_shouldReturnBadRequest() throws Exception {
        ...
        mockMvc.perform(post(APIUrls.AUTHORIZE_NET_API + APIUrls.GET_BILLING_HISTORY)
