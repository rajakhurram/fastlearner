package com.vinncorp.fast_learner.integration.authorize_net.additional_service;
...
import com.vinncorp.fast_learner.services.authorize_net.IAuthorizeNetSubscriptionService;
...
public class AuthNetAdditionalSubscriptionIntegrationTest {

    @Autowired
    private IAuthNetAdditionalSubscriptionService service;

    @Autowired
    private IAuthorizeNetSubscriptionService authorizeNetSubscriptionService;
    ...
    @Test
    @DisplayName("Cancel authorize net subscription")
    @Order(1)
    public void testCancelAuthorizeNetSubscription_whenProvidedValidValue() throws InternalServerException, BadRequestException, EntityNotFoundException {
        ...
        var m = authorizeNetSubscriptionService.create(subscriptionRequest, "student@mailinator.com");

        subscribedUserRepository
                .findByUserEmail("student@mailinator.com")
                .ifPresent(user -> {
                    try {
                        service.cancelAuthorizeNetSubscription(user.getSubscribedId());
    ...
    @Test
    @DisplayName("Update authorize net subscription")
    @Order(2)
    public void testUpdateSubscription_whenProvidedValidValue() throws InternalServerException, BadRequestException, EntityNotFoundException, EntityAlreadyExistException {
        ...
        // create a subscription
        var newSubscription = authorizeNetSubscriptionService.create(subscriptionRequest, "student@mailinator.com");
        ...
        // Act
        var m = service.updateAuthorizeNetSubscription("student@mailinator.com", "test", "customerProfileId", "customerPaymentProfileId");
