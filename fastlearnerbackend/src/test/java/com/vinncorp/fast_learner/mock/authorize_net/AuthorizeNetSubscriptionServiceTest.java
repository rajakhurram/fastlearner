package com.vinncorp.fast_learner.mock.authorize_net;
...
class AuthorizeNetSubscriptionServiceTest {

    @InjectMocks
    private AuthorizeNetSubscriptionService authorizeNetSubscriptionService;
    ...
    @Mock
    private IAuthNetAdditionalSubscriptionService authNetAdditionalSubscriptionService;
    ...
    public static SubscribedUser createSubscribedUser() {
        ...
        subscribedUser.setAuthorizeNetSubscriptionId("authorizeNetSubId123"); // Authorize.Net subscription ID
    ...
    void testCreateSubscription_WithCouponAndNoExistingSubscription() throws Exception {
        ...
        Message<String> response = authorizeNetSubscriptionService.create(request, email);
    ...
    void testCreateSubscription_AlreadySubscribedToSamePlan() throws EntityNotFoundException {
        ...
        BadRequestException ex = assertThrows(BadRequestException.class,
                () -> authorizeNetSubscriptionService.create(request, email));
    ...
    void testValidationOnChangingPlan_ThrowsWhenTransactionCreatedToday() throws EntityNotFoundException {
        ...
        subscribedUser.setAuthorizeNetSubscriptionId("sub-123");
        ...
        BadRequestException ex = assertThrows(BadRequestException.class,
                () -> authorizeNetSubscriptionService.validationOnChangingPlan(subscribedUser));
    ...
    void testValidationOnChangingPlan_NoActiveTransactionHistory() throws EntityNotFoundException, BadRequestException {
        ...
        subscribedUser.setAuthorizeNetSubscriptionId("subscribedId123");
        ...
        // Test the method
        boolean result = authorizeNetSubscriptionService.validationOnChangingPlan(subscribedUser);
    ...
    void testValidationOnChangingPlan_TransactionCreatedOnDifferentDay() throws EntityNotFoundException, BadRequestException {
        ...
        // Verify that the method findByLatestTransactionHistoryBySubsIdAndStatus was called once with the expected arguments
        verify(transactionHistoryService, times(1))
                .findByLatestTransactionHistoryBySubsIdAndStatus("authorizeNetSubId123", GenericStatus.ACTIVE);
    }
    ...
    void testValidationOnChangingPlan_SubscribedUserNull() throws EntityNotFoundException, BadRequestException {
        ...
        assertThrows(NullPointerException.class,
                () -> authorizeNetSubscriptionService.validationOnChangingPlan(null));
    }
    ...
    void getBillingHistory_whenValidInputs_thenReturnsBillingHistory() throws Exception {
        SubscribedUser subscribedUser = SubscribedUserTestData.subscribedUser();
        subscribedUser.setAuthorizeNetSubscriptionId("123456123");
        ...
        // Act
        Message<List<BillingHistoryResponse>> actualMessage = authorizeNetSubscriptionService.getBillingHistory(new BillingHistoryRequest(), "test@email.com");
        ...
        verify(authNetAdditionalSubscriptionService, times(1)).getSubscriptionById(subscribedUser.getAuthorizeNetSubscriptionId());
    }
    ...
    void getBillingHistory_whenProvidedWrongEmail_thenThrowsEntityNotFoundException() throws EntityNotFoundException, InternalServerException {
        ...
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> {
            authorizeNetSubscriptionService.getBillingHistory(new BillingHistoryRequest(), "test@email.com");
        });

        assertEquals("User not found", exception.getMessage());

        verify(subscribedUserService, times(1)).findByUser("test@email.com");
        verify(authNetAdditionalSubscriptionService, times(0)).getSubscriptionById(anyString());
    }
    ...
    void getBillingHistory_whenCustomerProfileIdIsNull_thenThrowsBadRequestException() throws EntityNotFoundException, InternalServerException {
        SubscribedUser subscribedUser = SubscribedUserTestData.subscribedUser();
        subscribedUser.setAuthorizeNetSubscriptionId(null);
        when(subscribedUserService.findByUser("test@email.com")).thenReturn(subscribedUser);
    ...
    void getBillingHistory_whenAuthNetServiceFails_thenThrowsInternalServerException() throws Exception {
        when(subscribedUserService.findByUser("test@email.com")).thenReturn(SubscribedUserTestData.subscribedUser());
        when(authNetAdditionalSubscriptionService.getSubscriptionById(SubscribedUserTestData.subscribedUser().getAuthorizeNetSubscriptionId())).thenThrow(new InternalServerException("Service failed"));
        ...
        verify(subscribedUserService, times(1)).findByUser("test@email.com");
        verify(authNetAdditionalSubscriptionService, times(1)).getSubscriptionById(SubscribedUserTestData.subscribedUser().getAuthorizeNetSubscriptionId());
    }
    ...
    void updateSubscription_Success() throws EntityNotFoundException, BadRequestException, InternalServerException {
        ...
        subscribedUser.setAuthorizeNetSubscriptionId("sub123");
        ...
        when(authNetAdditionalSubscriptionService.updateAuthorizeNetSubscription(anyString(), anyString(), anyString(), anyString())).thenReturn(null);

        // Act
        Message<String> response = authorizeNetSubscriptionService.updateSubscription(1L, "test@example.com");
    ...
    void updateSubscription_ProfileAlreadyDefault() throws EntityNotFoundException {
        ...
        // Act & Assert
        BadRequestException exception = assertThrows(BadRequestException.class, () -> {
            authorizeNetSubscriptionService.updateSubscription(1L, "test@example.com");
        });
    ...
    void updateSubscription_NoAuthorizeNetSubscription() throws EntityNotFoundException {
        var subscribedUser = new SubscribedUser();
        subscribedUser.setId(1L);
        subscribedUser.setCustomerProfileId("cust123");
        subscribedUser.setAuthorizeNetSubscriptionId(null);
    ...
    void testFreeSignUpSubscription_Success() throws Exception {
        ...
        Message<String> actualResponse = authorizeNetSubscriptionService.freeSignUpSubscription(1L, email);
    ...
    void testFreeSignUpSubscription_UserNotFound() throws EntityNotFoundException {
        ...
        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> {
            authorizeNetSubscriptionService.freeSignUpSubscription(1L, email);
        });
