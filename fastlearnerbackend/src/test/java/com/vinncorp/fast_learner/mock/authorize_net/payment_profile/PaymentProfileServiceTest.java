...
import com.vinncorp.fast_learner.mock.authorize_net.additional_service.AuthNetAdditionalSubscriptionTestData;
...
public class PaymentProfileServiceTest {
    ...
    @Test
    @DisplayName("Create auth net customer profile when provided invalid data")
    void createAuthNetCustomerProfile_Error_Response_Null() throws InternalServerException {
        ...
        when(restClient.makeRequest(any(), any(), any(), any()))
                .thenThrow(new InternalServerException("Something went wrong with Authorize.Net api"));
    ...
    @Test
    @DisplayName("Should create AuthNet customer profile successfully")
    ...
    void testAuthNetCreateCustomerProfile_NullResponse() throws InternalServerException {
        ...
        assertEquals("Something went wrong with Authorize.Net api", ex.getMessage());
    }

    @Test
    @DisplayName("Should not throw if duplicate profile code returned")
    void testAuthNetCreateCustomerProfile_DuplicateCode() throws InternalServerException {
        var response = new CreateCustomerPaymentProfileResponse();
    ...
    @Test
    @DisplayName("Should create AuthNet customer profile successfully")
    void testCreateAuthNetCustomerProfile_Success() throws InternalServerException {
    ...
    @Test
    @DisplayName("Should throw InternalServerException when AuthNet API connection fails")
    void testUpdateAuthNetCustomerProfile_NullResponse() throws InternalServerException {
        // Execute and assert
        ...
        when(restClient.makeRequest(any(), any(), any(), any()))
                .thenThrow(new RuntimeException(new InternalServerException("Something went wrong with Authorize.Net api")));

        assertEquals("Something went wrong with Authorize.Net api", exception.getMessage());
    }

    @Test
    @DisplayName("Should throw InternalServerException for error response from AuthNet API")
    void testUpdateAuthNetCustomerProfile_ErrorResponse() throws InternalServerException {
    ...
    void testUpdateAuthNetCustomerProfile_ExceptionDuringExecution() throws InternalServerException {
    ...
    @Test
    @DisplayName("Should throw InternalServerException for error response from AuthNet API")
    void testUpdateAuthNetCustomerProfile_ErrorFromAPI() throws InternalServerException {
        PaymentProfileDetailRequest detail = new PaymentProfileDetailRequest();
    ...
    void testUpdateAuthNetCustomerProfile_NullDetail() {
        assertThrows(InternalServerException.class, () -> {
    ...
    @Test
    @DisplayName("Should throw InternalServerException when AuthNet API returns error result")
    void testUpdateAuthNetCustomerProfile_AuthNetErrorResult() throws InternalServerException {
        PaymentProfileDetailRequest detail = new PaymentProfileDetailRequest();
    ...
    @Test
    @DisplayName("Should throw InternalServerException when AuthNet API connection fails")
    void testGetAuthNetCustomerPaymentProfile_NullResponse() throws InternalServerException {
    ...
    @Test
    @DisplayName("Should throw InternalServerException for error response from AuthNet API")
    void testGetAuthNetCustomerPaymentProfile_ErrorResponse() throws InternalServerException {
        // Execute and assert
        InternalServerException exception = assertThrows(InternalServerException.class, () -> {
            service.getCustomerPaymentProfile("profileId", "paymentProfileId");
        });
    ...
    @Test
    @DisplayName("Should handle exceptions thrown during API execution")
    void testGetAuthNetCustomerPaymentProfile_ExceptionDuringExecution() throws InternalServerException {
    ...
    @Test
    @DisplayName("Should throw InternalServerException when AuthNet API connection fails")
    void testGetAuthNetCustomerPaymentProfileList_NullResponse() throws InternalServerException {
        // Execute and assert
        InternalServerException exception = assertThrows(InternalServerException.class, () -> {
    ...
    void testGetAuthNetCustomerPaymentProfile_SuccessfulResponse() throws InternalServerException {
        // Arrange
        Message message = new Message();
    ...
    @Test
    @DisplayName("Should throw InternalServerException for error response from AuthNet API")
    void testGetAuthNetCustomerPaymentProfileList_ErrorResponse() throws InternalServerException {
        // Execute and assert
        InternalServerException exception = assertThrows(InternalServerException.class, () -> {
            service.getCustomerPaymentProfileList("profileId");
        });
    ...
    @Test
    @DisplayName("Should handle exceptions thrown during API execution")
    void testGetAuthNetCustomerPaymentProfileList_ExceptionDuringExecution() throws InternalServerException {
        // Execute and assert
        InternalServerException exception = assertThrows(InternalServerException.class, () -> {
            service.getCustomerPaymentProfileList("profileId");
        });
    ...
    @Test
    @DisplayName("Should throw InternalServerException when AuthNet returns error result code")
    void testGetAuthNetCustomerPaymentProfile_ErrorResponseCode() throws InternalServerException {
        // Arrange
        Message message = new Message();
        ...
        assertEquals("Authorize.Net Subscription: Invalid profile ID", exception.getMessage());
    }


    @Test
    @DisplayName("Should throw InternalServerException when exception is thrown during request execution")
    void testGetAuthNetCustomerPaymentProfile_ExceptionThrown() throws InternalServerException {
        when(restClient.makeRequest(any(), any(), any(), any()))
                .thenThrow(new InternalServerException("Something went wrong with Authorize.Net api"));
    ...
    @Test
    @DisplayName("Should throw InternalServerException when AuthNet API connection fails")
    void testDeleteAuthNetCustomerPaymentProfile_NullResponse() throws InternalServerException {
    ...
    @Test
    @DisplayName("Should throw InternalServerException for error response from AuthNet API")
    void testDeleteAuthNetCustomerPaymentProfile_ErrorResponse() throws InternalServerException {
        // Execute and assert
        SubscribedUser subscribedUser = new SubscribedUser();
        InternalServerException exception = assertThrows(InternalServerException.class, () -> {
            service.deleteCustomerPaymentProfile("profileId", "paymentProfileId", subscribedUser);
    ...
    @Test
    @DisplayName("Should handle exceptions thrown during API execution")
    void testDeleteAuthNetCustomerPaymentProfile_ExceptionDuringExecution() throws InternalServerException {
        // Execute and assert
        SubscribedUser subscribedUser = new SubscribedUser();
        InternalServerException exception = assertThrows(InternalServerException.class, () -> {
            service.deleteCustomerPaymentProfile("profileId", "paymentProfileId", subscribedUser);
    ...
    void testCreateCustomerProfile_ErrorResponse() throws InternalServerException {
        SubscriptionRequest requestDTO = AuthNetAdditionalSubscriptionTestData.subscriptionRequest();
    ...
    @Test
    @DisplayName("Should update AuthNet customer profile successfully")
    void testUpdateAuthNetCustomerProfile_Success() throws InternalServerException {
        PaymentProfileDetailRequest detail = new PaymentProfileDetailRequest();
        ...
        // Mock getAuthNetCustomerPaymentProfile
