...
public class CreateProcessMockTest {
    ...
    void testProcessSubscription_firstTimeToPaidSubscription_Success() throws Exception {
        when(authNetAdditionalSubscriptionService.createFirstTime(any(), any(), any(), any(), any(), any(), any(), any(), any()))
                .thenReturn(response);
    ...
    @Test
    @DisplayName("Test process subscription when authorize net subscription throw error")
