...
import com.vinncorp.fast_learner.services.authorize_net.additional_service.DowngradeAuthNetSubscriptionService;
...
class DowngradeProcessMockTest {
    ...
    @Mock
    private DowngradeAuthNetSubscriptionService downgradeAuthNetSubscriptionService;
    @Mock
    ...
    void testProcessSubscription_WithExistingProfile_ShouldDowngradeSuccessfully() throws Exception {
        ...
        when(downgradeAuthNetSubscriptionService.downgrade(any(), any(), any(), any(), any(), any(), any(), any()))
        ...
        verify(authNetAdditionalSubscriptionService).cancelAuthorizeNetSubscription(oldHistory.getAuthSubscriptionId());
