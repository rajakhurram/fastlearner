...
import com.vinncorp.fast_learner.services.authorize_net.additional_service.UpdateAuthNetSubscriptionService;
...
public class UpdateProcessMockTest {
    ...
    @Mock private UpdateAuthNetSubscriptionService updateAuthNetSubscriptionService;
    @Mock private AuthNetAdditionalSubscriptionService authNetAdditionalSubscriptionService;
    ...
    public void testProcessSubscription_withExistingProfileAndPaidPlan() throws Exception {
        ...
        when(updateAuthNetSubscriptionService.update(any(), any(), any(), any(), any(), any(), any(), any(), any())).thenReturn(new Message<String>().setMessage("Updated"));
        ...
        verify(authNetAdditionalSubscriptionService).cancelAuthorizeNetSubscription("sub123");
    }
    ...
    public void testProcessSubscription_createProfileWhenMissing() throws Exception {
        ...
        when(updateAuthNetSubscriptionService.update(any(), any(), any(), any(), any(), any(), any(), any(), any())).thenReturn(new Message<String>().setMessage("Created new profile"));
    ...
    public void testProcessSubscription_freePlanCancelsPendingSubscription() throws Exception {
        ...
        when(updateAuthNetSubscriptionService.update(any(), any(), any(), any(), any(), any(), any(), any(), any())).thenReturn(new Message<String>().setMessage("Free upgraded"));
