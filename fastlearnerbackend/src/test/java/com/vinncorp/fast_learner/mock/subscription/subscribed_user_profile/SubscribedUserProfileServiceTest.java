...
public class SubscribedUserProfileServiceTest {
    ...
    void setUp() {
        ...
        subscribedUser.setAuthorizeNetSubscriptionId("49843748593");
    ...
    void deleteSubscribedUserProfile_whenDeletingPaymentProfileFails_thenThrowsInternalServerException() throws EntityNotFoundException, InternalServerException, BadRequestException {
        ...
        doThrow(new InternalServerException("Failed to delete payment profile")).when(subscribedUserProfileService).deletingPaymentProfileFromAuthNetServer(subscribedUserProfile);
