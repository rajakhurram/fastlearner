...
describe('SignInComponent', () => {
  ...
  it('should handle sign-in error with 400 status', fakeAsync(() => {
    ...
    component.validateForm.get('email').setValue('saifurrehman@vinncorp.com');
    component.validateForm.get('password').setValue('12345678');
    component.submitForm();
    tick(2000); // Fast-forward 2 seconds to simulate async behavior

    expect(messageService.error).toHaveBeenCalledWith(errorResponse.error.message);
  }));
