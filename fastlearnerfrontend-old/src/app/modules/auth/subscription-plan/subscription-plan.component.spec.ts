...
describe('SubscriptionPlanComponent', () => {
  ...
  beforeEach(async () => {
    ...
    authSpy.verifyUserSubscription.and.returnValue(of());
  ...
  describe('subscribeToPlan', () => {
    it('should subscribe to Free Plan and navigate on success', (done) => {
      ...
      subscriptionService.loadSubscriptionPermissions.and.returnValue(of(null));
      subscriptionService.fetchCurrentSubscriptionPlanType.and.returnValue(of('FREE'));
      ...
      setTimeout(() => {
        ...
        expect(subscriptionService.updateUserSubscriptionCheck).toHaveBeenCalledWith(true);

        expect(router.navigateByUrl).toHaveBeenCalledWith(environment.basePath);
