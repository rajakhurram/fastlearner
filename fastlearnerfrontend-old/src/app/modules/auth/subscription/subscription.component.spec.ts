...
describe('SubscriptionComponent', () => {
  ...
  it('should open SubscriptionPlan when openSubscriptionPlan is called', () => {
    const modal = { afterClose: of(null) };
    modalService.create.and.returnValue(modal as any);
    component.subscriptionDetails = { subscriptionId: 123 };
    ...
    expect(modalService.create).toHaveBeenCalledWith(
      jasmine.objectContaining({
        ...
        nzComponentParams: {
          ...
          showFreePlan: true,
          currentPlanId: component.subscriptionDetails.subscriptionId,
        },
        nzViewContainerRef: jasmine.any(ViewContainerRef),
        nzFooter: null,
        nzKeyboard: true,
  ...
  // ============================================================================================= //
  // NOTE: Commenting this line since we are not calling the getBillingHistory from this component //
  // ============================================================================================= //
