...
describe('InstructorComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      imports: [AntDesignModule, BrowserAnimationsModule, SharedModule, NzIconModule],
      providers: [
        ...
        { provide: NZ_ICONS, useValue: [LockFill] }
      ],
  ...
  it('should route to create course page', () => {
    ...
    expect(router.navigate).toHaveBeenCalledWith(['/instructor/content-type']);
  });
