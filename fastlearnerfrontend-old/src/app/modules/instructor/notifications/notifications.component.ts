...
export class NotificationsComponent implements OnInit {
  ...
  isOverflow = false;
  // Reference to the notification container element
  @ViewChild('notificationContainer', { static: false })
  private notificationContainer: ElementRef<HTMLDivElement>;
  ...
  getNotifications(options?: { scrollToBottom: boolean }): void {
  ...
  showMoreNotifications() {
    ...
    this.getNotifications({ scrollToBottom: true });
  }
