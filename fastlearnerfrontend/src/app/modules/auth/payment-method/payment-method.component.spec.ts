...
describe('PaymentMethodComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, FormsModule, AntDesignModule, BrowserAnimationsModule],
  ...
  it('should create subscription successfully', () => {
    ...
    subscriptionService.loadSubscriptionPermissions.and.returnValue(of());
    subscriptionService.fetchCurrentSubscriptionPlanType.and.returnValue(of({}));
    subscriptionService.updateUserSubscriptionCheck(true);
    cacheService.getDataFromCache.and.returnValue(null);
    
    component.addSubscription();
    console.log("sessionId: ", component.sessionId);
    console.log("isMobile: ", component.isMobile);
