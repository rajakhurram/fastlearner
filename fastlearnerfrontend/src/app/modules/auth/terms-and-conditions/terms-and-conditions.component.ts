...
export class TermsAndConditionsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({
      name: 'description',
      content: 'Read Quality Center’s Terms and Conditions for platform use. Understand your rights, obligations, and guidelines for a seamless learning experience.',
    });
  }
}
