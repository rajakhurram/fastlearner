...
describe('DealComponent', () => {
  ...
  beforeEach(async () => {
    ...
    modalRefSpy = jasmine.createSpyObj('NzModalRef', ['destroy']);
    viewContainerRefSpy = jasmine.createSpyObj('ViewContainerRef', ['element']);
    subscriptionServiceSpy = jasmine.createSpyObj<SubscriptionService>('SubscriptionService', ['loadSubscriptionPermissions']);
    subscriptionServiceSpy.loadSubscriptionPermissions.and.returnValue(of())
