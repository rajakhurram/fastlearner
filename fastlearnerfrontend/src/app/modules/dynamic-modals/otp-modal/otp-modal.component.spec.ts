...
describe('OtpModalComponent', () => {
  ...
  describe('onOtpChange', () => {
    it('should emit OTP code when 5 digits are entered', () => {
      spyOn(component.otpCodeEmitter, 'emit');
      component.onOtpChange('123456');
      expect(component.otpCodeEmitter.emit).toHaveBeenCalledWith('123456');
    });
  });
