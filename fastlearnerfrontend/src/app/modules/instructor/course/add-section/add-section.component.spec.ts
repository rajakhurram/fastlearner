...
describe('AddSectionComponent', () => {
  ...
  describe('deleteTopics', () => {
    it('should create a deletion modal with the correct parameters', () => {
      ...
      mockModalRef.afterClose.and.returnValue(of(true));

      const createSpy = spyOn(component['_modal'], 'create')
        .and.returnValue(mockModalRef as any);
  ...
  describe('sectionValidation', () => {
    it('should return true if all sections and their topics are valid and type is test', () => {
      component.sections = [
        {
          name: 'Section 1',
          delete: false,
    ...
    it('should return true if all sections and their topics are valid and type is survey', () => {
      component.sections = [
        {
          name: 'Section 1',
          delete: false,
  ...
  it('should set contentScreen to false and select content type', () => {
    ...
    const type = component.typeVideo;
  ...
  it('should save the quiz if valid', () => {
    const topic = { validate: false, completed: false, quiz: { type: 'TEST' } };
        ...
        questions: [
          {
            ...
            answers: [
              { delete: false, ans: 'Answer 1', isCorrectAnswer: true },
              { delete: false, ans: 'Answer 2' },
            ],
            questionType: { key: 'MULTIPLE_CHOICE' }, // needed for conditional
          },
        ],
        title: 'Quiz Title',
        durationInMinutes: 10,   // required
        passingCriteria: 1,      // required
      },
      topicStatusImg: '',
      validate: false,
    };
