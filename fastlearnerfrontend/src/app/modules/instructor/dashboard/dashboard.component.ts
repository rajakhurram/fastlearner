...
export class DashboardComponent implements OnInit {
  ...
  openConfirmationModal(courseId?: number, courseStatus?: CourseStatus) {
    const action = courseStatus === CourseStatus.PUBLISHED ? 'Publish' :
    courseStatus === CourseStatus.UNPUBLISHED ? 'Unpublish' : 'Update';
    const modal = this._modal.create({
      ...
      nzComponentParams: {
        msg:
          ...
          this.capitalizeFirstLetter(action.toLowerCase()) +
          ' the course?', 
