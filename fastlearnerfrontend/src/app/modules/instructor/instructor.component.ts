...
export class InstructorComponent implements OnInit {
  ...
  constructor(
    ...
    // Only update selectedRoute with the actual URL without query params
  ...
  changeTabColor(value?: any) {
    this.activeTab(false, false, false, false, false, false, false, false, false, false);
  ...
  routeToCreateCourse() {
    ...
    this.menuVisible = false;
    this.sideBarVisible = false;
    this._router.navigate(['/instructor/content-type']); // Change this
