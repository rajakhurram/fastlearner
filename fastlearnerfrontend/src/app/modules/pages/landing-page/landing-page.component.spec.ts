  ...
  const mockCourseList = [
    {
      ...
      metaTitle:
        'The Unsung Selldiers Effective Sales Strategies | QualityCenter',
      metaDescription:
        'Discover effective sales strategies with Selldiers. Learn from an experienced professional on our learning platform, QualityCenter, to improve your sales skills',
      enrolled: false,
      favourite: false,
    },
    {
      ...
      metaTitle: 'Master Adobe Firefly: Beginner to Expert Guide | QualityCenter',
      metaDescription:
    ...
    },
    {
      ...
      metaTitle: 'Full-Stack Developer Bootcamp | QualityCenter',
      metaDescription:
    ...
    },
    {
      ...
      metaTitle: 'Digital Marketing Essentials | QualityCenter',
      metaDescription:
