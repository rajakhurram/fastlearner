...
export class PricingPageComponent implements OnInit, OnDestroy {
  ...
  features = [
    ...
    },
    {
      ...
      longDescription:
        'Experience the future of learning with QualityCenter.ai’s built-in AI chat assistant. Ask questions, clear concepts, and explore new ideas in real time. Whether you need instant explanations, subject guidance, or quick study support, our AI ensures you never learn alone.',
    ...
    },
    {
      ...
      longDescription:
        ' QualityCenter.ai enhances your learning journey by recommending alternate instructors who teach the same subject in different ways. Gain diverse insights, compare teaching approaches, and build a deeper, more complete understanding of every topic.',
    ...
    },
    {
      ...
      longDescription:
        ' Celebrate your progress with official QualityCenter.ai certificates, awarded upon course or test completion. Professionally designed and globally shareable, they showcase your verified achievements and strengthen your professional profile on LinkedIn, résumés, and portfolios.',
