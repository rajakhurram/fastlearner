...
describe('CourseListComponent', () => {
  ...
  it('should render the course cards when courseList is populated', () => {
    ...
    mockCourses[0].courseDuration = '3 hours 57 minutes';

    expect(component.courseList.length).toBe(1);
    expect(component.courseList[0]).toEqual(mockCourses[0]);
  });
