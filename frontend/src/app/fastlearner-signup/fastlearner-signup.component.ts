...
import { FormGroup, FormControl, NonNullableFormBuilder, Validators, ValidatorFn, AbstractControl, ValidationErrors } from '@angular/forms';
import { Router, ActivatedRoute } from '@angular/router';
import { NzModalService } from 'ng-zorro-antd/modal';
import { environment } from 'src/environments/environment.development';
import { HttpConstants } from '../core/constants/http.constants';
import { Providers } from '../core/enums/providers';
...
@Component({
  selector: 'app-fastlearner-signup',
  templateUrl: './fastlearner-signup.component.html',
  styleUrls: ['./fastlearner-signup.component.scss']
})
export class FastlearnerSignupComponent {
  ...
  routeToSignIn() {
    this._communicationService.flLoginStateChange(true);
  }
