...
export class LandingPageComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  items: AccordionItems[] = [
    {
      ...
      description: `Quality Center differs from other online learning platforms due to its innovative features, such as AI-powered Q&A for swift answers, customizable learning paths for a tailored experience, and video summaries for quick review.
      `,
      isExpanded: false,
    },
    {
    ...
    },
    {
      ...
      description: `A quick learner is a person who can understand new information in a short amount of time. When someone learns quickly, they typically have excellent communication and listening abilities. Quality Center.ai will help you learn quickly by providing innovative AI-based learning tools.
      `,
      isExpanded: false,
    },
    {
  ...
  ngOnInit(): void {
    this.metaService.updateTag({
      name: 'description',
      content: `Join Quality Center’s AI based learning platform for quick learning. Access top courses from experts, boost your skills with AI assistance & become a Quality Center`,
    });
